...
namespace ClassLibrary1HR.LeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20231203124201_InitialHrDB")]
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 12, 3, 15, 42, 0, 933, DateTimeKind.Local).AddTicks(7240),
                            DateModified = new DateTime(2023, 12, 3, 15, 42, 0, 933, DateTimeKind.Local).AddTicks(7254),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
